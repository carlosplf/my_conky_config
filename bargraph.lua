	...
	local bars_settings = {
		{
			...
			mid_colour = { { 0.25, 0x137333, 1 }, { 0.7, 0xf1f725, 1 }, { 0.9, 0xFF0000, 1 } },
...

		{
			...
			bg_colour = { 0xE6E6E6, 0.3 },
			fg_colour = { 0x00FF00, 1 },
			mid_colour = { { 0.25, 0x02c744, 1 }, { 0.7, 0xf1f725, 1 }, { 0.9, 0xFF0000, 1 } },
			alarm_colour = { 0xff0000, 0.5 },
			smooth = true,
			led_effect = "r",
			x = 24,
